...
## 操作方法です
「CLICK」ボタンを押してエンジンを消費して毛糸を目標地点まで運搬しなければ「CLEAR」できません。

## オブジェクトの説明です
エンジン:クリックボタンを押すとエンジンが減り、エンジンがすべて減ると猫が意志を失って毛糸が目標地点に行けなくなります。

毛糸:猫が目標地点まで投げられる物体で、毛糸を使って物体を合わせます。

スプリング:毛糸がスプリングに触れるとエンジンを消費する分だけスプリングが減り、クリックボタンを解除するとスプリングが力を受けた分だけ飛び出します。

カーペット:「摩擦」で、毛糸がカーペットに面エンジンをすばやく失います。 障害物と同じです。
